        ...
        section_heading(ui, "Decoder & channel DSP");
            ui.horizontal(|ui| {
                ...
                let bigram = ui.selectable_label(
                    self.skimmer_ui.skimmer.decoder == SkimmerDecoderKind::Bigram,
                    "Bigram beam",
                );
                attach_rich_tooltip(
                    &bigram,
                ...
                let adaptive = ui.selectable_label(
                    self.skimmer_ui.skimmer.decoder == SkimmerDecoderKind::Adaptive,
                    "Adaptive",
                );
                attach_rich_tooltip(
                    &adaptive,
            ...
            scroll_slider_f32(ui, &mut self.skimmer_ui.skimmer.min_decode_snr_db, 6.0..=40.0, "Decode min SNR");
